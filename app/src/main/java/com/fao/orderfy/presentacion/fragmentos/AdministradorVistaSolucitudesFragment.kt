...
class AdministradorVistaSolucitudesFragment : Fragment(), RegistroListener {
    ...
    private fun cargarDatosSolicitud() {
        ...
        viewModelRegistro.consultarRegistro(object : MainListener {
            override fun onSuccess(response: JsonArray) {
                ...
                adaptadorRegistro =
                    RegistroAdapter(registroList, this@AdministradorVistaSolucitudesFragment)
    ...
    override fun onSelectedItem(registro: Registro) {
        val action =
            AdministradorVistaSolucitudesFragmentDirections.actionAdministradorVistaSolucitudesFragmentToAdministradorVistaSolicitudEspFragment(
                registro
            )
