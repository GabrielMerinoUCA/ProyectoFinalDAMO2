 ...
 * Use the [ContinuarRegistroVendedorFragment.newInstance] factory method to
...
class ContinuarRegistroVendedorFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ContinuarRegistroVendedorFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ContinuarRegistroVendedorFragment().apply {
